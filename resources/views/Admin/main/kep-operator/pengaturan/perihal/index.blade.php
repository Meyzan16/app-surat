...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Perihal Surat</h3>

            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Perihal Surat</a></li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('kep-operator.data-perihal.trash') }}" class='sidebar-link'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('data-perihal.destroy', $item->id) }}" method="POST" class="d-inline">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('data-perihal.store') }}" method="POST">
                @csrf 
    ...
    <div class="modal fade" id="edit_data{{ $item1->id  }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('data-perihal.update', $item1->id) }}" method="POST">
                    @csrf  @method('put')
                    <div class="modal-body">
